...
namespace ZSharpVault16lib
{
    public class FileHelper
    {
        ...
        public static bool uploadFiletoVaultFolder(VDF.Vault.Currency.Connections.Connection connection, string folderID, string comment, string fileName, byte[] fileBytes)
        {
            try
            {
